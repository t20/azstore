<form class="adminform" action="add_page.php" method="get" accept-charset="utf-8">
    ...
    <label for="page_name">Page Name</label><input type="text" name="page_name" value="" id="page_name">
    <label for="maxitems">Max Items</label><input type="text" name="maxitems" value="" id="maxitems">
